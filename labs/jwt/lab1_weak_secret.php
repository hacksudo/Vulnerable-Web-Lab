...
$secret = "secret123";
$flag = "flag{weak_secret_key_broken}";
$token = "";
$message = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['token_submit'])) {
        ...
        $decoded = verify_jwt_hs256($user_token, $secret);
        if ($decoded && isset($decoded['isadmin']) && $decoded['isadmin'] === true) {
            ...
            $message = "<p style='color:red'>❌ Invalid token or insufficient privileges.</p>";
        }
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>🔐 Lab 1 – Weak Secret Key</title>
    <style>
...
<body>
    ...
    <h1>🔓 Lab 1 – Weak Secret Key</h1>
    <p>This lab uses a weak secret key <code>secret123</code>. Try generating and modifying a JWT to gain admin access.</p>
    ...
    <div class="footer">
        ...
        <ul>
            <li><a href="https://portswigger.net/web-security/jwt/lab-jwt-secret-key-crack" target="_blank">PortSwigger – JWT Secret Key Crack</a></li>
